<x-nav-bar></x-nav-bar>
<div class="flex">
  <div class="md:w-1/4 p-4 md:ml-4">
    ...
    <hr class="my-12 mb-2 border-gray-400">
      ...
      <div class="mt-4">
        ...
        <ul class="space-y-4 mt-2">
          <a href="#" class="text-gray-600 text-md hover:underline"><h2 class="text-lg font-semibold text-gray-600">Permissions</h2></a>
        </ul>
        <ul class="space-y-4 mt-2">
          <a href="#" class="text-gray-600 text-md hover:underline"><h2 class="text-lg font-semibold text-gray-600">Roles</h2></a>
        </ul>
...
<section class="py-8 w-3/4">
  ...
  <!-- ... Your content for the left section goes here ... --><div class="w-1/4 rounded-lg border border-gray-200 shadow-md">
