...
<h1 class="inline text-3xl font-semibold text-gray-700">Browse College of <strong>{{Str::title($college)}}</strong></h1>
</div>
...
<div class="lg:col-span-3 bg-gray-100 md:border p-4">
  <div>
    ...
    <ul class="space-y-4 mt-2">
      <li>
        <a href="course.html" class="text-gray-600 text-md hover:underline">Bachelor of Arts in Communication</a>
      </li>
      <li>
        <a href="course.html" class="text-gray-600 text-md hover:underline">Bachelor of Science in Biology</a>
      </li>
      <li>
        <a href="#" class="text-gray-600 text-md hover:underline">Bachelor of Science in Computer Science</a>
      </li>
      <li>
        <a href="#" class="text-gray-600 text-md hover:underline">Bachelor of Science in Geology</a>
      </li>
      <li>
        <a href="#" class="text-gray-600 text-md hover:underline">Bachelor of Science in Information Technology</a>
      </li>
      <li>
        <a href="#" class="text-gray-600 text-md hover:underline">Bachelor of Science in Mathematics</a>
      </li>
    </ul>
    ...
    <ul class="space-y-4 mt-2">
      <li>
        <a href="#" class="text-gray-600 text-md hover:underline">Gina Claveria</a>
      </li>
      <li>
        <a href="#" class="text-gray-600 text-md hover:underline">Gina Claveria</a>
      </li>
