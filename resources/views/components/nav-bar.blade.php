...
<nav class="bg-navy-blue px-5 md:px-14 shadow-md font-sans font-semibold text-sm md:text-base">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2 md:p-4 transition duration-700 ease-in-out">
